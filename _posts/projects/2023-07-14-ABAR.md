...
| <img src="../../assets/img/blog/Untitled7.png" width = "50%"> | 1. CockTail List : 각 바텐더들의 주종목 칵테일을 보여주는 GridView <br />2. BartenderList : 추가된 바텐더를 보여주는 ListView <br />3. Add Button : 바텐더를 추가하는 Button  <br />     →click시 AddProfilePage로 이동 <br />4. Update/Remove Button : 리스트 수정 및 삭제하는 Button<br />    →click시 수정/삭제 팝업 |
| ------------------------------------------------------------ | ------------------------------------------------------------ |
